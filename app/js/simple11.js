import { calculateBorderLength, drawStoryline } from '../../src/js/utils/drawerB'
...
const jsonReadTwo = d3Fetch.json('../../data/json/Match11/Mock_Events_Data_1.json') // Killing info file generated by python
...
async function drawEvents(graph, participantsInfo, nexusKiller, nexusKillerId) {
  await jsonReadTwo.then(function(result) {
    ...
    for (let i in data) {
      ...
      let interacteeBorder, interactorBorder
