...
import $ from 'jquery'
import { warn } from 'mocha/lib/utils'

// Initialise json files
const jsonRead = d3Fetch.json('../../data/json/EUW1_5922388644Info.json') // Info of match
const jsonReadTwo = d3Fetch.json('../../data/json/newKillingInfo.json') // Killing info file generated by python
const jsonDBSCAN = d3Fetch.json('../../data/json/dbscan4.json') // DBSCAN result
